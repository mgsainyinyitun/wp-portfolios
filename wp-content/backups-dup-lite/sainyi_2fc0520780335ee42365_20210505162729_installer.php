...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'sainyi_2fc0520780335ee42365_20210505162729_archive.zip';
	const ARCHIVE_SIZE		 = '45816097';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2fc0520-05162729';
    const SECONDARY_PACKAGE_HASH = 'd0390d9-05162729';
	const VERSION			 = '1.4.0';
